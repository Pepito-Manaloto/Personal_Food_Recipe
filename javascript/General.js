function loginAjax()
{
    $("#loginButton").click(function()
                            {               
                                ...
                                var datastr ='name=' + name + '&password=' + password;
        
                                $.ajax({
                                    type: "POST",
                                    url: "http://localhost/Recipe/php_scripts/Login_script.php",
                                    ...
                                    data: datastr
                                }).done( function(result,b,c)
                                         {
                                            ...
                                            else
                                            {
                                                ...
                                                window.location.href = "http://localhost/Recipe/Home/";
                                            }
...
function registerAjax()
{
    $("#registerButton").click(function()
                                {               
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "http://localhost/Recipe/php_scripts/Register_script.php", 
                                        beforeSend: function(xhr)
                                                    {
                                        ...
                                        data: datastr           
                                    }).done( function(result)
                                             {
                                                ...
                                                else
                                                {
                                                    ...
                                                    setTimeout(function() 
                                                                {
                                                                    window.location.href = "http://localhost/Recipe/Login/";
                                                                },500);
                                                }
                                             });
...
function navigationBarActions()
{
    ...
    $("#nameLink, #nameNavList").hover(
                            function()
                            {
                                ...
                                $("#nameLink img").attr("src", "http://localhost/Recipe/images/chef_hat_hover.png");    
                            },
                            function()
                            {
                                $("#nameNavList").css("display", "none");
                                $("#nameLink img").attr("src", "http://localhost/Recipe/images/chef_hat.png");
                            });                         
}
    ...
    $(button).click(function(e)
                                {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "http://localhost/Recipe/php_scripts/" + script, 
                                        ...
                                        data: JSON.stringify(jsonObject)            
                                    }).done( function(result)
                                             {
                                                ...
                                                if(result == "Recipe Added!")
                                                    window.location.href = "http://localhost/Recipe/Browse_Recipe/?type=My";
    ...
    $("body").on("click","#deleteLink", function(e)
                            {
                                ...
                                if(result == true)
                                {
                                    ...
                                    $.ajax({
                                        ...
                                        type: "POST",
                                        url: "http://localhost/Recipe/php_scripts/DeleteRecipe_script.php", 
                                        contentType: "application/json; charset=UTF-8",
    ...
    $("#editProfileButton").click(function(e)
                        {
                            ...
                            $.ajax({
                                        type: "POST",
                                        url: "http://localhost/Recipe/php_scripts/EditUser_script.php", 
                                        beforeSend: function(xhr)
                                                    {
                                        ...
                                        data: datastr       
                                    }).done( function(result)
                                             {
                                                ...
                                                else
                                                {
                                                    ...
                                                    setTimeout(function() 
                                                                {
                                                                    window.location.href = "http://localhost/Recipe/Profile/";
                                                                },500); 
                                                }                                                                       
                                             });
    ...
    $("#orderTitleHeader").click(function(e)
                        { 
                            ...
                            $.ajax({
                                        ...
                                        url: "http://localhost/Recipe/php_scripts/ViewRecipeSort_script.php?type="+ typeParam +"&page=" + pageParam + "&order="+orderBy + "&category=" + sortCategory
                                    }).done(function(result)
                                            {
